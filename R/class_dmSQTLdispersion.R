...
setMethod("dmSQTLplotDispersion", "dmSQTLdispersion", function(x, out_dir = NULL){
  ...
  # tagwise_dispersion = x@tagwise_dispersion; mean_expression = x@mean_expression; nr_features = IRanges::width(x@counts@partitioning); common_dispersion = x@common_dispersion
